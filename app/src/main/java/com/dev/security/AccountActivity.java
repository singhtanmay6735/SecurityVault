...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BiometricPrompt biometricPrompt = new BiometricPrompt(AccountActivity.this, executor, new BiometricPrompt.AuthenticationCallback() {
            @Override
        ...
        // BIOMETRIC DIALOG
        final BiometricPrompt.PromptInfo promptInfo = new BiometricPrompt.PromptInfo.Builder().setTitle("Security Vault")
